...
export { default as StonkIcon } from "./Icons/Stonk";
export { default as StonkRoundIcon } from "./Icons/StonkRound";
...
export { default as ProgressStonk } from "./Icons/ProgressStonk";
